...
<%@page import="net.seniorglez.controller.ServletController"%>
<%@page import="net.seniorglez.model.*"%>
...
<body>
	...
	<form action="Shoop.jsp" method="post">
		<b>Products:</b> <select name="product">
			...
			%>
			<option value="<%=prod.hashCode()%>"><%=prod%></option><!-- Antes era un code normal, cuidado -->
			<%
				}
			%>
			...
			<table>
				...
				<tr>
					<td><input type="checkbox" name="productCheck"
						value="<%=p.hashCode()%>"></td><!-- antes era code -->
